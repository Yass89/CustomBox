...
let Produit = function(ref, price, description) {
    this.ref = ref;
    this.price = price;
...
let product4 = new Produit("médaille d'identification", "5", "La médaille d'identification est personnalisable selon vos envies.");
